...
INSERT INTO `laundry_list` (`id`, `customer_name`, `location`,`status`, `queue`, `total_amount`, `pay_status`, `amount_tendered`, `amount_change`, `remarks`, `date_created`) VALUES
(2, 'James Smith',`location`,3, 1, 555, 1, 555, 0, 'None', '2020-09-23 11:54:47'),
(4, 'Claire Blake',`location`, 3, 1, 250, 1, 500, 250, 'None', '2020-09-23 13:29:33');
